...
# Tight refinement around best region from table
phi_values = np.linspace(1.05, 1.20, 8)
M4_values  = np.linspace(9.0e-8, 1.30e-7, 8)
f_values   = np.linspace(1.25, 1.40, 5)
