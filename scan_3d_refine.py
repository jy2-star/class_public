...
# Refined ranges centered on best coarse result
phi_values = np.linspace(0.80, 1.05, 6)
M4_values  = np.linspace(6.5e-8, 9.0e-8, 6)
f_values   = np.linspace(0.90, 1.20, 6)
    ...
    for M4 in M4_values:
        for phi_ini in phi_values:
            ...
            try:
                ...
                # Normalized score for all 3 constraints equally weighted
